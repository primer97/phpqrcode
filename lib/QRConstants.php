...
class QRConstants
{
    ...
    public const QR_FIND_FROM_RANDOM = false; // if false, checks all masks available, otherwise see QR_FIND_COUNT_MASK, mask id are got randomly
    public const QR_FIND_COUNT_MASK = 5; // when QR_FIND_FROM_RANDOM is true, this value tells count of masks need to be checked, mask id are got randomly
