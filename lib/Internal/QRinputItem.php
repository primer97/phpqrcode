...
class QRinputItem
{
    ...
    private function encodeModeNum(int $version):int
    {
        try
        {
            ...
            $val = 0x1;
            $bs->appendNum(4, $val);
            $bs->appendNum(QRspec::lengthIndicator(QRConstants::QR_MODE_NUM, $version), $this->size);
    ...
    private function encodeModeAn(int $version):int
    {
        try
        {
            ...
            $bs->appendNum(4, 0x02);
            $bs->appendNum(QRspec::lengthIndicator(QRConstants::QR_MODE_AN, $version), $this->size);
    ...
    private function encodeMode8(int $version):int
    {
        try
        {
            ...
            $bs->appendNum(4, 0x4);
            $bs->appendNum(QRspec::lengthIndicator(QRConstants::QR_MODE_8, $version), $this->size);
    ...
    private function encodeModeKanji(int $version):int
    {
        try
        {
            ...
            $bs->appendNum(4, 0x8);
            $bs->appendNum(QRspec::lengthIndicator(QRConstants::QR_MODE_KANJI, $version), (int)($this->size/2));
    ...
    public function estimateBitStreamSizeOfEntry(int $version):int
    {
        ...
        switch($this->mode)
        {
            ...
            case QRConstants::QR_MODE_STRUCTURE:
                return QRConstants::STRUCTURE_HEADER_BITS;
            default:
                return 0;
        }
